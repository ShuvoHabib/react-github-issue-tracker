...
if(USE_STATIC_DATA) {
  ...
  mock.onGet('https://api.github.com/repos/facebook/react/issues?per_page=25&page=1')
    .reply(200, page1.data, {link: page1.link});
  mock.onGet('https://api.github.com/repos/facebook/react/issues?per_page=25&page=2')
    .reply(200, page2.data, {link: page2.link});
  mock.onGet('https://api.github.com/repos/facebook/react/issues?per_page=25&page=3')
    .reply(200, page3.data, {link: page3.link});
  mock.onGet('https://api.github.com/repos/facebook/react/issues?per_page=25&page=49')
